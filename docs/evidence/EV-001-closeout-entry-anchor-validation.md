...
## Checks
```text
python -m unittest using-harness.tests.test_harness_closeout_check
python -m unittest discover using-harness\tests
python using-harness\scripts\knowledge_check.py --root using-harness --docs-path docs
python using-harness\scripts\harness_closeout_check.py --file using-harness\docs\evidence\EV-001-closeout-entry-anchor-validation.md
python using-harness\scripts\skill_metadata_check.py --root using-harness
python using-harness\skills\using-harness\scripts\skill_metadata_check.py --root using-harness
```
...
- `python -m unittest using-harness.tests.test_harness_closeout_check`: 8 tests passed.
- `python -m unittest discover using-harness\tests`: 18 tests passed.
