...
| [F014](F014-project-rules-human-authorized-governance.md) | project-rules | AGENTS.md, project rules, user authorization, promotion boundary | templates/AGENTS.md; skills/harness-project-rules | Project rule promotion or AGENTS guidance changes. |
| [F015](F015-stop-only-hook-runtime.md) | hook runtime | Stop hook, Stop-only, completion claim guard, hook diagnostics, optional hooks | skills/using-harness/hooks; skills/using-harness/scripts/hook_diagnostics.py; hooks.json; hooks/hooks.json; README.md; INSTALL.md; docs/quickstart.md | Stop-only behavior, completion claim guard, hook diagnostics, or hook installation guidance changes. |
