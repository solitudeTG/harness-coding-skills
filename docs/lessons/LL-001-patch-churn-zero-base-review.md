...
scope: project
source_feature_ids: []
applies_to: [harness-skills, incident-learning, vision-gate, project-rules]
created: 2026-05-16
updated: 2026-05-16
---
...
- `harness-knowledge-capture` 和 `harness-readiness-dashboard` 必须报告 `Patch Churn Review` 状态；没有该状态时，重复补丁 Feature 不能无条件标记 ready。
